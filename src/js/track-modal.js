(function($) {
  ...
  var tracks = [
   ...
   
    {
      ...
      body:
        "<h3 id=\"1sharedcalendar\">1. Shared Calendar</h3><ul><li><p><strong>Suggested Audience:</strong> Second years</p></li><li><p><strong>Description:</strong> Shared calendar is an android app to solve the problem of clashes of student activities in the college. You will design a calendar that will be readable.</p></li><li><p><strong>Goals:</strong> </p><ul><li>Build the shared calender up to completion/adequate progress.</li></ul></li><li><p><strong>Requirements:</strong> </p><p><ul><li>Knowledge of Java, XML and Android basics.</li></p><p><li>Knowledge of database persistence.</li></ul><p></p></li></ul></p><h3 id=\"2newsroom\">2. Newsroom</h3><ul><li><p><strong>Suggested Audience:</strong> First years</p></li><li><p><strong>Description:</strong> An android app in which each club/student chapter of our college will have a tab/page through which people can subscibe. Allow clubs/student chapters to register if they have a Facebook page. The app will fetch latest information posted on the actual Facebook page and show it in the newsroom page, provide notifications etc.</p></li><li><p><strong>Goals:</strong> </p><ul><li>Phase 1: Build the frontend for the app.</li><li>Phase 2: Using Facebook Graph API, fetch the posts from the respective Facebook pages and add subscription system.</li></ul></li><li><p><strong>Requirements:</strong> </p><ul><li>Knowledge of Java, XML and Android basics.</li><li>Knowledge of networking and database persistence.</li></ul></li><li><p><strong>Resources:</strong></p><p><ul><li>Refer the Graph API documentation: https://developers.facebook.com/docs/graph-api</li></ul><p></p></li></ul></p>",
